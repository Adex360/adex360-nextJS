...
import { ClipboardCheck, NotebookPen, Send, Target } from "lucide-react";
...
const steps = [
  {
    ...
    title: "Strategizing",
    description:
      "We audit your site, keywords and competitors to craft a data-backed SEO roadmap.",
    offset: "lg:mt-0",
    badge: "01",
  ...
  },
  {
    ...
    description:
      "On-page, technical and off-page optimizations are rolled out across your site.",
    offset: "lg:mt-24",
    badge: "02",
  ...
  },
  {
    ...
    title: "Refinement",
    description:
      "We track rankings, refine keywords and compound your organic growth.",
    offset: "lg:mt-6",
    badge: "03",
    badgePos: "-right-1 bottom-1",
  },
        ...
        <div className="text-center">
          ...
          <h2 className="mt-3 overflow-hidden pb-1 text-2xl font-extrabold text-ink sm:text-3xl lg:text-4xl">
            <span data-sp-heading="" className="block">
              SEO Service Initiation Process
            </span>
          </h2>
        </div>

    ...
    <section className="overflow-hidden bg-surface px-4 py-14 sm:px-6 md:py-20 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div data-reveal-group="" className="mx-auto mt-12 grid max-w-4xl grid-cols-1 gap-6 md:grid-cols-2">
          <div data-reveal="left" className="flex flex-col rounded-3xl border border-[#E4E8F3] bg-white p-7 sm:p-8">
          ...
          <div data-reveal="right" className="relative rounded-3xl bg-gradient-to-br from-[#F7B45C] via-brand-blue-light to-brand-blue p-[1.5px] shadow-2xl shadow-brand-900/15">

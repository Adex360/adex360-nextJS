...
const tabs: ServiceTab[] = [
  {
    eyebrow: "Seamless UI/UX",
    label: "Front End Development",
    icon: Code2,
    heading: "Visuals That Speak",
    description:
      "We create responsive, visually appealing websites with HTML, CSS, and JavaScript, ensuring accessibility, dynamic interactions, and an optimized user experience.",
    checks: ["Build responsive designs", "Improve UX/UI", "Using modern frameworks"],
    cta: "Bring Designs To Life",
  },
  {
    eyebrow: "Powerful and Scalable",
    label: "Back End Development",
    icon: Database,
    heading: "The Invisible Coding Hero",
    description:
      "Adex360 develops server-side logic, databases, and APIs for secure data handling, authentication, and smooth, fast website performance for users.",
    checks: ["Manage databases", "Ensure secure functionality", "Build APIs"],
    cta: "Backend That Scales",
  },
  {
    eyebrow: "Built To Sell",
    label: "Ecommerce Development",
    icon: ShoppingCart,
    heading: "From Cart to Checkout",
    description:
      "We develop online stores with secure payments, seamless checkout, and optimized listings, using Shopify or WooCommerce for efficient inventory and customer management.",
    checks: ["Seamless shopping experiences", "Integrate payments and shipping", "Optimize for conversions"],
    cta: "Convert Clicks To Sales",
  },
  {
    eyebrow: "Reliable and Secure",
    label: "Site Maintenance",
    icon: Wrench,
    heading: "We Fix Bugs Faster Than a Sci-Fi Reboot",
    description:
      "Website maintenance ensures security, functionality, and updates with regular patches, troubleshooting, and performance enhancements for an optimal user experience.",
    checks: ["Simplify content management", "Customize CMS platforms", "Optimize for SEO"],
    cta: "Upgrade Without Downtime",
  },
  {
    eyebrow: "Peak Performance",
    label: "Performance Optimization",
    icon: Rocket,
    heading: "We Make Your Site Binge-Worthy!",
    description:
      "Adex360 boosts rankings, traffic, and speed with keyword optimization, code refinement, caching, SEO, and image compression for better performance.",
    checks: ["Boost SEO rankings.", "Improve speed and load times.", "Optimize for mobile."],
    cta: "Speed Up Now",
  },
  {
    eyebrow: "Effortless Management",
    label: "CMS Development",
    icon: Layers,
    heading: "Like Legos for your website – We Build All",
    description:
      "Adex360 develops CMS solutions, enabling easy content updates without technical skills using platforms like WordPress, Joomla, and Drupal for seamless management.",
    checks: ["Provide updates and backups.", "Fix bugs and improve performance.", "Ensure security."],
            ...
            return (
              <div key={t.label}>
                <button
                  ...
                  aria-controls="webdev-services-panel"

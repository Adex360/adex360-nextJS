...
const typicalAgency = [
  "“Custom” sites that somehow look exactly like every other template.",
  "Slow, unoptimized, and invisible to Google— perfect for staying irrelevant.",
  "Works fine, until real traffic comes in— then it collapses spectacularly.",
  "Pretty designs with zero strategy— because who needs actual conversions?",
];

const adex360 = [
  "Unique websites built for your brand, not another generic, overpriced template.",
  "Fast, SEO-friendly, and optimized to rank higher and convert better.",
  "Scalable solutions that grow with your business— no costly rebuilds required.",
  "Designed to look great and actually generate leads, not just exist.",
];

export default function WebDevAdvantage() {
  return (
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-xs font-semibold uppercase tracking-wide text-muted">
                  Where Websites Go to Underperform
                </p>
              </div>
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-xs font-semibold uppercase tracking-wide text-emerald-600">
                    Web Development That Drives Growth
                  </p>
                </div>

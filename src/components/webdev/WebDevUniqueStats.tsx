...
const BARS = [40, 55, 48, 68, 60, 82, 100];
const RADIUS = 64;
const CIRCUMFERENCE = 2 * Math.PI * RADIUS;
const DONUT_TARGET = CIRCUMFERENCE * 0.5; // 50% filled

export default function WebDevUniqueStats() {
        ...
        <div className="flex flex-col items-center gap-5 text-center xs:flex-row xs:gap-6 xs:text-left">
          <div className="relative h-40 w-40 shrink-0">
            <svg viewBox="0 0 160 160" className="h-full w-full -rotate-90">
              ...
              />
              <defs>
                <linearGradient id="webdevDonutGrad" x1="0" y1="0" x2="1" y2="1">
      ...
      <div className="relative z-10 mt-4 rounded-3xl bg-brand-950 p-6 text-white shadow-2xl shadow-brand-900/30 xs:-mt-5 xs:ml-8">
        <div className="flex items-end justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-white/60">Growth in website traffic</p>
          </div>

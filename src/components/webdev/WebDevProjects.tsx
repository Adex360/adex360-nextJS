...
const projects = [
  { name: "Premium Footwear", service: "Web Development", gradient: "from-brand-blue to-brand-900" },
  { name: "Fashion Retail", service: "Web Development", gradient: "from-[#F7B45C] to-[#C26F0B]" },
  { name: "B2C Home Décor", service: "Web Development", gradient: "from-brand-600 to-brand-blue" },
];

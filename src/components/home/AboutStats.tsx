    ...
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 lg:grid-cols-2">
        <div className="relative mx-auto grid w-full max-w-md grid-cols-2 gap-4">
          <div className="col-span-2 flex items-center gap-4 rounded-3xl bg-white p-6 shadow-2xl shadow-brand-900/10">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-brand-orange/10 text-brand-orange">
              <PieChart className="h-8 w-8" />
            </div>
            <div>
              <p className="text-3xl font-extrabold text-ink">75%</p>
              <p className="text-sm text-muted">
                Of Brands Experienced Highest Monthly Sales
              </p>
            </div>
          </div>
          <div className="col-span-2 flex items-center gap-4 rounded-3xl bg-brand-900 p-6 text-white shadow-2xl shadow-brand-900/20">

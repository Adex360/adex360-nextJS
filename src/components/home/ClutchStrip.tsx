  ...
  return (
    <section className="border-t border-black/5 bg-surface px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-8">
        <span className="text-sm font-semibold text-muted">As Featured On</span>
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="flex items-center gap-2 rounded-xl bg-white px-5 py-3 shadow-sm shadow-brand-900/5"
          >

...
const BARS = [38, 52, 46, 65, 58, 79, 100];
const RADIUS = 64;
const CIRCUMFERENCE = 2 * Math.PI * RADIUS;
const DONUT_TARGET = CIRCUMFERENCE * 0.3; // 70% filled

export default function ShopifyUniqueStats() {
        ...
        <div className="flex flex-col items-center gap-5 text-center xs:flex-row xs:gap-6 xs:text-left">
          <div className="relative h-40 w-40 shrink-0">
            <svg viewBox="0 0 160 160" className="h-full w-full -rotate-90">
              ...
              />
              <defs>
                <linearGradient id="shopifyDonutGrad" x1="0" y1="0" x2="1" y2="1">
          ...
          <div>
            <p className="text-sm font-bold leading-snug text-ink">
              Increased Shopify Store Engagement
            </p>
      ...
      <div className="relative z-10 mt-4 rounded-3xl bg-brand-950 p-6 text-white shadow-2xl shadow-brand-900/30 xs:-mt-5 xs:ml-8">
        <div className="flex items-end justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-white/60">Traffic growth</p>
          </div>

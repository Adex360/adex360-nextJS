...
const typicalAgency = [
  "Every client gets the same “custom” strategy—copy, paste, repeat. Genius.",
  "Generic posts that scream we tried, but not really. Please clap.",
  "They'll post something, but actual results? Oh, that's a different (expensive) package.",
  "Fancy reports filled with graphs, but no real insights or next steps.",
];

const adex360 = [
  "Data-driven tactics, not outdated marketing myths pretending to be “expert strategies.”",
  "No cringe quotes or lifeless stock photos—just content people actually engage with.",
  "Everything handled in one place, so you're not chasing clueless agencies.",
  "Insights when you need them, not after your budget has already burned.",
];

export default function SocialAdvantage() {
  return (

...
const projects = [
  { name: "Luxury Pret Wear", service: "Social Media Management", gradient: "from-brand-blue to-brand-900" },
  { name: "Fashion & Apparel", service: "Social Media Management", gradient: "from-[#F7B45C] to-[#C26F0B]" },
  { name: "Heritage Fashion Ecommerce", service: "Social Media Management", gradient: "from-brand-600 to-brand-blue" },
];

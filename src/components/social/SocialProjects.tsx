...
import imgLuxuryPretWear from "../../../public/images/portfolio/nishat.png";
import imgFashionApparel from "../../../public/images/portfolio/beechtree.png";
import imgHeritageFashionEcommerce from "../../../public/images/portfolio/seona.png";

const projects = [
  { name: "Luxury Pret Wear", service: "Social Media Management", href: "/nishat-usa", image: imgLuxuryPretWear },
  { name: "Fashion & Apparel", service: "Social Media Management", href: "/beechtree", image: imgFashionApparel },
  {
    name: "Heritage Fashion Ecommerce",
    service: "Social Media Management",
    href: "/seona",
    image: imgHeritageFashionEcommerce,
  },
];
        ...
        >
          <div className="text-center sm:text-left">
            <h3 className="text-xl font-extrabold sm:text-2xl">
              <span className="text-[#E38A19]">Social media success stories</span>
            ...
            <p className="mt-2 max-w-xl text-sm leading-relaxed text-muted">
              ...
              how we&apos;ve transformed brands with expert social media
              strategies!
            </p>
          </div>
          <Link

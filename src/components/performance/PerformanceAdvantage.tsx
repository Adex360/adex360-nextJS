...
const typicalAgency = [
  "Generic ad templates recycled for every client — because your brand is exactly like everyone else's, right?",
  "Set-and-forget campaigns that burn budget faster than they convert.",
  "Reporting that shows clicks and impressions, but never the results that matter.",
  "A one-size-fits-all funnel, regardless of your product, audience, or goals.",
];

const adex360 = [
  "Data-driven campaigns that maximize ROI instead of blindly burning ad budgets.",
  "Smart targeting reaches each buyer, not random internet users.",
  "Continuous optimization guarantees every dollar spent works harder for you.",
  "Transparent reports with real insights, not just pretty but useless graphs.",
];

export default function PerformanceAdvantage() {
  return (

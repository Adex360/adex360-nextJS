...
import imgFootwearRetail from "../../../public/images/portfolio/ecs.png";
import imgUrbanFashionLifestyleRetail from "../../../public/images/portfolio/one.png";
import imgSkinCareMakeup from "../../../public/images/portfolio/kiko.png";

const projects = [
  { name: "Footwear Retail", service: "Performance Marketing", href: "/ecs", image: imgFootwearRetail },
  {
    name: "Urban Fashion & Lifestyle Retail",
    service: "Performance Marketing",
    href: "/one",
    image: imgUrbanFashionLifestyleRetail,
  },
  { name: "Skin Care & Makeup", service: "Performance Marketing", href: "/kiko-milano", image: imgSkinCareMakeup },
];
        ...
        >
          <div className="text-center sm:text-left">
            <h3 className="text-xl font-extrabold sm:text-2xl">
              <span className="text-[#E38A19]">Performance Marketing success stories</span>
            ...
            <p className="mt-2 max-w-xl text-sm leading-relaxed text-muted">
              ...
              how we&apos;ve transformed brands with expert performance

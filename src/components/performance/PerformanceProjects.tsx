...
const projects = [
  { name: "Footwear Retail", service: "Performance Marketing", gradient: "from-brand-blue to-brand-900" },
  { name: "Urban Fashion & Lifestyle Retail", service: "Performance Marketing", gradient: "from-[#F7B45C] to-[#C26F0B]" },
  { name: "Skin Care & Makeup", service: "Performance Marketing", gradient: "from-brand-600 to-brand-blue" },
];

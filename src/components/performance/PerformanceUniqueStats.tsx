...
const BARS = [36, 50, 44, 62, 57, 76, 96];
const RADIUS = 64;
const CIRCUMFERENCE = 2 * Math.PI * RADIUS;
const DONUT_TARGET = CIRCUMFERENCE * 0.4; // 60% filled

export default function PerformanceUniqueStats() {
        ...
        <div className="flex flex-col items-center gap-5 text-center xs:flex-row xs:gap-6 xs:text-left">
          <div className="relative h-40 w-40 shrink-0">
            <svg viewBox="0 0 160 160" className="h-full w-full -rotate-90">
              ...
              />
              <defs>
                <linearGradient id="perfDonutGrad" x1="0" y1="0" x2="1" y2="1">
          ...
          <div>
            <p className="text-sm font-bold leading-snug text-ink">
              Increase In Per Day Sales For Ad-Driven Clients
            </p>
